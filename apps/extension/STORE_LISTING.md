...
- Privacy policy live at `https://app.agent42.cz/privacy` (deployed from `apps/web/src/app/privacy/page.tsx`).
...
- **Popis\*** — paste:
  ...
  Podrobné zásady ochrany soukromí: https://app.agent42.cz/privacy
  ```
...
- **Adresa URL domovské stránky** — `https://app.agent42.cz`
- **Adresa URL podpory** — `https://app.agent42.cz/privacy`
...
- **Privacy policy URL** — `https://app.agent42.cz/privacy`
...
| "Privacy policy URL not reachable"       | Verify `https://app.agent42.cz/privacy` returns 200 from outside your network before submitting.                   |
