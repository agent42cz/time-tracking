...
export function ConfirmModal({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'w-full max-w-md overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-lg',
        )}
      >
        <div className="px-5 py-4">
          ...
          {description ? <div className="mt-1.5 text-sm text-zinc-600">{description}</div> : null}
