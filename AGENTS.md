...
> Entry point for AI coding agents. Keep this file under 150 lines. When something would push it past the limit, move it into `docs/` and link to it from here. If your agent reads `AGENTS.md` instead, run `ln -s AGENTS.md AGENTS.md` locally — the symlink is intentionally not committed because prettier can't format symlinks.
