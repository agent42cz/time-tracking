...
export default [
  {
    ignores: [
      ...
      '**/test-results/**',
      '**/generated/**',
      // An unpacked release zip (apps/extension/time-tracker-extension-v*/) is a
      // build output like dist/ — minified bundles that lint as thousands of
      // no-unused-expressions errors. The zip itself is already gitignored.
      'apps/extension/time-tracker-extension-v*/**',
      'pnpm-lock.yaml',
      // Generated by `next build` and overwritten on every build. Next 15.5 emits a
      // triple-slash reference to .next/types/routes.d.ts, which our own
      // @typescript-eslint/triple-slash-reference rule rejects — and the file says
      // in its own header that it must not be edited.
      '**/next-env.d.ts',
    ],
  },
